...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-JDHJ6S3KCT"></script>
    <script>
        ...
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="bg-[#2E2E44] p-8 rounded-lg shadow-lg max-w-xs mx-auto tablet:max-w-[30rem]">
                ...
                <div class="border-t border-[#3A3A4D] pt-6 mb-6">
                    <p class="text-3xl font-bold">R$ 29,90 <span class="text-sm text-[#A0A0B1]">/ mês</span></p>
                </div>
                ...
                <a href="https://wa.me/{{str_replace('+', '', config('twilio.from'))}}" class="bg-[#20C997] text-white px-6 py-3 rounded-lg shadow-lg hover:bg-[#4A6AD1] transition duration-300">Assine Agora</a>
            </div>
        </div>
    </section>
